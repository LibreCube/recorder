...
namespace server
{
    ...
    bool canspawnitem(int type) { return true; }
    ...
    int spawntime(int type)
    {
        ...
        switch(type)
        {
            ...
            case I_ROUNDS:
            case I_GRENADES:
            case I_CARTRIDGES: sec = 1; break;
            case I_HEALTH: sec = 1; break;
            case I_GREENARMOUR: sec = 1; break;
            case I_YELLOWARMOUR: sec = 1; break;
            case I_BOOST: sec = 30; break;
    ...
    void shotevent::process(clientinfo *ci)
    {
        ...
        sendf(-1, 1, "rii9x", N_SHOTFX, ci->clientnum, gun, id,
                ...
                ci->ownernum);
        //bool headshot;
        //if(to.z>ci->o)headshot=true;
        //if(from.dist(to)> )
        gs.shotdamage += guns[gun].damage*(gs.quadmillis ? 2 : 1)*4*guns[gun].rays;
        switch(gun)
        {
