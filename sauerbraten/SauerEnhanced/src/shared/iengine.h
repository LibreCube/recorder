...
//extern void regular_particle_splash_d(int type, int num, int fade, const vec &p, int color, float size, int radius, int gravity);
...
/*extern void particle_splash_s(int type, int num, int fade, const vec &p, int color = 0xFFFFFF, float size = 1.0f, int radius = 150, int gravity = 2, vec v = vec(0,0,0));
...
//extern void particle_trail_w(const vec &from, const vec &to);
...
// sound
extern int playsound(int n, const vec *loc = NULL, extentity *ent = NULL, int loops = 0, int fade = 0, int chanid = -1, int radius = 128, int vol = 0);
