    ...
    void calc(particle *p, int &blend, int &ts, vec &o, vec &d, bool step = true)
    {
        ...
        else
        {
            ...
            if(o.z < p->val && step)
            {
                ...
                {
                    if(collide) adddecal(collide, vec(o.x, o.y, collidez), vec(p->o).sub(o).normalize(), 2*p->size, p->color, type&PT_RND4 ? (p->flags>>5)&3 : 0);
                    blend = 0;
                }
            }
        }
...
static partrenderer *parts[] =
{
    ...
    new quadrenderer("packages/particles/muzzleflash4a.jpg", PT_PART|PT_FEW|PT_TRACK), // muzzle flash
    new quadrenderer("packages/particles/muzzleflash4b.jpg", PT_PART|PT_FEW|PT_TRACK), // muzzle flash
    ...
    new quadrenderer("packages/particles/glow.png", PT_PART),
    new quadrenderer("packages/particles/glow.png", PT_PART|PT_TRACK),
    ...
    new taperenderer("packages/particles/smoketrail.png", PT_TAPE|PT_GLARE)
};
...
static void makeparticles(entity &e)
{
    ...
    switch(e.attr1)
    {
        case 0: //fire and smoke -  <radius> <height> <rgb> - 0 values default to compat for old maps
        {
            ...
            if(raycubelos(pos, camera1->o, occlusioncheck) && seflameglow )
        ...
        case 4:  //tape - <dir> <length> <rgb>
		{
            ...
            dir=e.attr2;
            dir &= 0x1F;
            if(dir < 15 && dir > 6 && separticles) regularshape(PART_RAIN, max(1+e.attr3, 1), colorfromattr(e.attr4=0xFFFFFF), 44, e.attr2>=128?30:20, 0, e.o, 3, 201, 2000, NULL, true); //check if imitates rain -> use enhanced one
        ...
        case 78:    //rain
        {
            if(separticles) regularshape(e.attr1==77?PART_SNOW:PART_RAIN, max(1+e.attr2, 1), colorfromattr(e.attr4), 44, e.attr2>=128?30:20, 0, e.o, e.attr1==77?1:3, e.attr1==77?200:201, e.attr1==77?350:1000, e.attr3, true);
            break;
        }
        case 79:
        {
